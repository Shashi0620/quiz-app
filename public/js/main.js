...
var app = {
      ...
      $(".chat-message button").on('click', function (e) {
        ...
        if (messageContent !== '') {
          ...
          if (currentQuestion.user_answer == null) {
            ...
            if (currentQuestion.answer == currentQuestion.user_answer.toUpperCase()) {
              playerScore += 10;
            } else {
              //playerScore -= 1;
            }
  ...
  helpers: {
    ...
    updatePlayerScore: function () {
      ...
      var html = `Your Score: ${playerScore}`
      $('.score-holder').html(html);
    },
    ...
    roomTimeOut: function () {
      ...
      var downloadTimer = setInterval(function () {
        if (timeleft == 0) {
          ...
          document.getElementById("room-timeout").innerHTML = "Room time ends in " + timeleft + " seconds";
        }
        timeleft -= 1;
      }, 1000);
    },
    ...
    showTimeOut: function () {
      ...
      var downloadTimer = setInterval(function () {
        ...
        timeleft -= 1;
      }, 1000);      //$('.time-out').text(timeleft + " seconds remaining");
